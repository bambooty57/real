...
export default function FarmerDetailModal({ farmer, isOpen, onClose }: FarmerDetailModalProps) {
  ...
  return (
    <div className="print-content">
      {/* 인쇄용 컨텐츠 - 항상 DOM에 존재하지만 평소에는 숨김 */}
      <div className="hidden print:block print:relative print:w-full print:min-h-screen print:bg-white">
        <div className="p-8">
          {/* 인쇄용 헤더 */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-center print:text-2xl">{farmer.name} 상세 정보</h1>
      ...
      {/* 화면용 모달 - 인쇄 시 숨김 */}
      <Dialog open={isOpen} onClose={onClose} className="relative z-50 print:hidden">
