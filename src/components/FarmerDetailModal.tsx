  ...
  return (
    <Dialog open={isOpen} onClose={onClose} className="relative z-50">
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4 print:static print:p-0">
        <Dialog.Panel className="w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-white rounded-lg shadow-xl print:max-w-none print:max-h-none print:shadow-none print:m-0 print:overflow-visible print-content">
          {/* 모달 내용 */}
