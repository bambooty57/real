  ...
  return (
    ...
    >
      <div className="print-content">
        ...
        {/* 모달 컨테이너 - 인쇄 시 전체 화면 */}
        <div className="relative min-h-screen grid place-items-center p-4 print:p-0">
          <Dialog.Panel className="w-full max-w-4xl bg-white rounded-lg shadow-xl print:max-w-none print:shadow-none print:m-0">
            {/* 모달 내용 */}
